...
static Key keys[] = {
	...
	{ MODKEY,                       XK_w,      spawn,          SHCMD("nmcli d wifi list | dmenu -l 32 -sb '#33333f' -sf '#3355ff' | awk '{print $1}' | xargs -L1 st -t 'st (floating)' -g 60x5 -e nmcli -a d wifi connect") },
	{ MODKEY,                       XK_c,      spawn,          SHCMD("passmenu -l 16 -sb '#33333f' -sf '#3355ff'") },
	{ MODKEY|ShiftMask,             XK_c,      spawn,          SHCMD("passmenu --type -l 16 -sb '#33333f' -sf '#3355ff'") },
	{0,                             XK_Print,  spawn,          SHCMD("import -window root Pictures/screenshots/screenshot_$(date '+%Y-%m-%d_%H:%M').png") },
	{ Mod1Mask,                     XK_Print,  spawn,          SHCMD("import Pictures/screenshots/screenshot_$(date '+%Y-%m-%d_%H:%M').png") },
